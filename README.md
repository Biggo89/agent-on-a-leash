...
| [`docs/`](docs/) | **The written docs.** A [quickstart](docs/QUICKSTART.md) to set up, start and use Leash offline or on the live sandbox, plus two web pages: [Agent on a Leash](docs/Agent%20on%20a%20Leash.html), how a customer's instruction becomes rules that check every payment, and [Leash Architecture](docs/Leash%20Architecture.html), the system design. |
